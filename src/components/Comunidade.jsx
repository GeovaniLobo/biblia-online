            ...
            {menuCompartilharAberto === post.id && (
              <div className={`absolute right-0 bottom-full mb-2 w-56 rounded-2xl border shadow-2xl p-2 z-50 space-y-1 ${darkMode ? 'bg-slate-800 border-slate-700 text-white' : 'bg-white border-slate-200 text-slate-900'}`}>
                ...
                <button 
                  ...
                  className="w-full text-left px-3 py-2 rounded-xl text-xs font-bold hover:bg-emerald-600 hover:text-white transition flex items-center gap-2.5 text-emerald-500"
                >
          ...
          <div className="relative">
            ...
            {menuCompartilharAberto === post.id && (
              <div className={`absolute right-0 top-full mt-2 w-56 rounded-2xl border shadow-2xl p-2 z-50 space-y-1 ${darkMode ? 'bg-slate-800 border-slate-700 text-white' : 'bg-white border-slate-200 text-slate-900'}`}>
                {/* Opções de partilha continuam aqui dentro */}
                ...
              </div>
            )}
          </div>
